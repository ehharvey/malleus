...
//go:embed "qls/domain/domain.graphqls"
...
var sources = []*ast.Source{
	{Name: "qls/domain/domain.graphqls", Input: sourceData("qls/domain/domain.graphqls"), BuiltIn: false},
}
...
) (model.NewDomain, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewDomain2githubᚗcomᚋehharveyᚋmalleusᚋinternalᚋgraphᚋmodelᚐNewDomain(ctx, tmp)
	}

	var zeroVal model.NewDomain
	return zeroVal, nil
}
...
func (ec *executionContext) _Mutation_createDomain(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDomain2ᚖgithubᚗcomᚋehharveyᚋmalleusᚋinternalᚋgraphᚋmodelᚐDomain(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewDomain(ctx context.Context, obj any) (model.NewDomain, error) {
...
func (ec *executionContext) unmarshalNNewDomain2githubᚗcomᚋehharveyᚋmalleusᚋinternalᚋgraphᚋmodelᚐNewDomain(ctx context.Context, v any) (model.NewDomain, error) {
